...
@approved_required
def home():
    # If an admin has flagged this user as needing to set up 2FA, redirect them.
    if getattr(current_user, "require_2fa_setup", False) and not current_user.totp_enabled:
